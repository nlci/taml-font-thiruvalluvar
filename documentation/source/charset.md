...
NLCI Tamil supports the Tamil script, nuktas from Grantha script, some Latin diacritics,
and a basic set of Latin characters.
...
The following character ranges are supported by these fonts:
